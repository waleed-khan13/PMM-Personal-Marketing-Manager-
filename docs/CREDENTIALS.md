...
| WhatsApp Cloud | [Meta Business system users](https://business.facebook.com/settings/system-users) | Assign the app and WhatsApp assets to a system user, then generate a permanent system-user token with the required WhatsApp permissions. |
