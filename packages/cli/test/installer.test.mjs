...
async function fixture() {
  ...
  await writeFile(
    ...
    JSON.stringify({ schemaVersion: 1, product: "socium", version: "1.0.2", target }),
  );
...
test("rejects wrong-product and path-like release metadata", () => {
  ...
  assert.throws(
    () => validateManifest({ schemaVersion: 1, product: "another-product", version: "1.0.2", assets: { [target]: asset } }, target),
    /unexpected product/,
  );
  assert.throws(
